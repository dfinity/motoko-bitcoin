...
- Taproot sighash now uses actual transaction values instead of hardcoded `locktime=0` and `version=2` (#14).
- **Breaking:** Lowercase character range in `Bech32.mo` was incorrect.
