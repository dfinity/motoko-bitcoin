    ...
    derivations = [
      {
        derivePath = #text "m/0";
        serialized = ?(
          "xpub68Gmy5EVb2BdFbj2LpWrk1M7obNuaPTpT5oh9QCCo5sRfqSHVYWex97WpDZz"
      ...
      },
      {
        ...
        serialized = ?(
          "xpub6FHUhLbYYkgFQiFrDiXRfQFXBB2msCxKTsNyAExi6keFxQ8sHfwpogY3p3s1"
      ...
      },
      {
        ...
        serialized = ?(
          "xpub6GX3zWVgSgPc5tgjE6ogT9nfwSADD3tdsxpzd7jJoJMqSY12Be6VQEFwDCp6"
  ...
  },
  {
    ...
    derivations = [
      ...
      },
      {
        ...
        serialized = ?(
          "xpub6CrnV7NzJy4VdgP5niTpqWJiFXMAca6qBm5Hfsry77SQmN1HGYHnjsZSujoH"
      ...
      },
      {
        ...
        serialized = ?(
          "xpub6FL2423qFaWzHCvBndkN9cbkn5cysiUeFq4eb9t9kE88jcmY63tNuLNRzpHP"
    ...
    derivations = [
      {
        derivePath = #text "0";
        serialized = ?(
          "xpub68NZiKmAB8RzFjKx2J3PtxJEdMCB7UTYUjg4p29EoBvwdqCGKNjhnKSLBDxF"
    ...
    derivations = [
      {
        derivePath = #text "0";
        serialized = ?(
          "xpub69AUMk3gsXB5iPXhnks7jE8yvUumnVydc8WVNa4XJHbMVPLzaX7R4zGMnb6P"
      ...
      },
      {
        derivePath = #text "0/0";
        serialized = ?(
          "xpub69u56b6HqhHBhLSrDGjJF3sdwGFD7sgkjQaM7uWWAcptW7UXVBQLaw53Eauf"
